...
-   **UI Toolkit:** [`Jetpack Compose`](https://developer.android.com/jetpack/compose "null")

-   **Design System:** [`Material 3`](https://m3.material.io/ "null")

-   **Asynchronous Programming:** [`Kotlin Coroutines`](https://kotlinlang.org/docs/coroutines-overview.html "null")

-   **Local Storage:** `SharedPreferences` for storing chat history and user preferences.

-   **Serialization:** [`Gson`](https://github.com/google/gson "null") for saving and loading conversation data.
...
### Ordered List for Installation

1.  **Clone the repo**

    ```
    git clone [https://github.com/your_username/ailegalassistant.git](https://github.com/your_username/ailegalassistant.git)
